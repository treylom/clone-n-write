...
설계 결함 (b) 복원·정본화 (2026-07-02 persona-skill-rebuild Phase 2):
  the author 글의 강점 중 하나는 블록/문단이 뚝뚝 끊기지 않고 **예고→받기→수미상관**으로 이어진다는
  것. 이 이음말 어휘를 2026-06-13 v3에서 실제 글에서 추출했으나 정본(40-final)에 전파 못 해
...
근거(정본):
  - LLM-Wiki 3편 발행본(the author 최종 편집) — 예고 질문·수미상관("정리하면")·다음편 훅의 실어휘.
...
CONNECTIVES = {
    ...
    "closing_move": {
        ...
        "patterns": [
            re.compile(r"(다시 (포스팅|올리|쓰겠|공유)|후속|아직 다듬|다듬어 가는 중|정답인 방법은 없|"
                       r"봐주셔서 감사|읽어주셔서 감사|여러분 덕분|ㅋㅋ+|허허)"),
        ],
        "examples": [
            "물론 정답인 방법은 없고, 저도 아직 다듬어 가는 중이에요.",
