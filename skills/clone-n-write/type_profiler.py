...
PROFILES = {
    "정보": {
        ...
        "note": "정보/튜토리얼 = 합니다체 일관(the canonical style profile A). 명사 종결로 끊고 해요 남발 ❌.",
    },
    "사색": {
        "haeyo_cap": 15,
        ...
        "note": "사색/논평 = 평어·음슴 위주(the canonical style profile A). 단정을 말줄임으로 눌러 여운.",
    },
    "홍보": {
        "haeyo_cap": 45,
        ...
        "note": "홍보 = 평어 도입 + 합니다 + 해요 친근 혼합(the canonical style profile C).",
    },
    "후기": {
        "haeyo_cap": 45,
